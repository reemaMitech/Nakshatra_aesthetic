        ...
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <h4 class="card-title mb-0" id="form-title">Add Purchase Bill</h4>
                ...
                <div class="card-body">
                    ...
                    <?php
                        // Check if the URL contains 'edit_purchase_bill'
                        $currentUrl = $_SERVER['REQUEST_URI'];
                        $showForm = (strpos($currentUrl, '/edit_purchase_bill') !== false);
                        ?>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <?php if(service('uri')->getSegment(2) == 'invoices'){ ?>
                                                    ...
                                                    <td>   
                                                        ...
                                                        <?php }else{ ?>
                                                            ...
                                                            <td>
                                                            <a href="<?=base_url(); ?>edit_purchase_bill/<?=$data->id ?>"><i class="far fa-edit me-2"></i></a>
                                                            <a href="<?=base_url(); ?>delete_compan/<?=$data->id ?>/tbl_purchase_bill" onclick="return confirm('Are You Sure You Want To Delete This Record?')"><i class="far fa-trash-alt me-2"></i></a>
                            ...
                            <div class="tab-pane fade <?php echo $showForm ? 'show active' : ''; ?>" id="pills-profile1" role="tabpanel" aria-labelledby="pills-profile-tab1">
                                    ...
                                    <div id="access-form">
                                            ...
                                            <form class="row " id="invoice_form" action="<?= base_url('set_purchase_bill_data'); ?>" method="post" enctype="multipart/form-data" novalidate>
