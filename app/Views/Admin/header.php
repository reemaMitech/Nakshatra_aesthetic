        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url(); ?>add_invoice">
                        <i class="icon">
                    ...
                    <?php if (in_array('dispatch', $menu_names)) : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url(); ?>dispatch">
                        ...
                        <?php if (in_array('add_row_Materials', $menu_names)) : ?>
                            <li class="nav-item">
                                <a class="nav-link " href="<?=base_url(); ?>add_row_Materials">
                                    ...
                                    <span class="item-name"> Raw Materials</span>
                                </a>
                            </li>
                          <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <?php if (in_array('goods_transfer', $menu_names)) : ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?=base_url(); ?>goods_transfer">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> B </i>
                                    <span class="item-name">Goods Transfer</span>
                                </a>
                            </li>
                            <?php endif; ?>
                    ...
                    <?php  if (in_array('add_courierService', $menu_names)) : ?>
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo base_url(); ?>add_courierService">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                          ...
                          <?php if (in_array('add_row_Materials', $menu_names)) : ?>
                            <li class="nav-item">
                                <a class="nav-link " href="<?=base_url(); ?>add_row_Materials">
                                    ...
                                    <i class="sidenav-mini-icon"> RM </i>
                                    <span class="item-name"> Raw Materials</span>
                                </a>
                            </li>
                          <?php endif; ?>
                          ...
                          <?php if (in_array('add_product', $menu_names)) : ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="<?php echo base_url(); ?>add_vendor">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                          ...
                          <?php if (in_array('add_branch', $menu_names)) : ?>
                            <li class="nav-item">
                                <a class="nav-link " href="<?php echo base_url(); ?>add_branch">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="<?php echo base_url(); ?>add_cash">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
